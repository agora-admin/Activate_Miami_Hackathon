...
export default function CardHorizontal() {
  return (
    ...
    {/* <div style={{ border: "1px solid black" }}> */}
       <Cards3>
        <CardImage2>hey</CardImage2>
        <CardInfo2>
        <CardSubheader2>Technology</CardSubheader2>
          <CardHeader2>Tech Club</CardHeader2>
          <CardSubheader3>Stay updated with the latest happenings in the tech world.</CardSubheader3>
